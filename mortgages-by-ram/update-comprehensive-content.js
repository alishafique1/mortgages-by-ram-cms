...
// Comprehensive Strapi API update script for Mortgages by Ram
const API_BASE = 'http://localhost:1337/api';

// Enhanced hero and services content
...
const servicePages = [
  {
    ...
    content: `# First-Time Home Buyers Guide

## Getting Started
Buying your first home is an exciting milestone! As a licensed mortgage agent, I'll guide you through every step of the process to ensure you make informed decisions.

## Pre-Approval Process
- **Free consultation** to assess your financial situation
- **Credit check** and income verification
- **Pre-approval letter** valid for 120 days
- **Budget planning** to determine your maximum purchase price
...
## Next Steps
Ready to get started? Contact me for a free consultation and pre-approval.`,
    blocks: [
      {
        "__component": "blocks.hero",
        "heading": "First-Time Home Buyers",
...
Ready to start? Contact me today for a free consultation!`
  ...
  },
  {
    ...
    content: `# Refinancing Solutions

## Why Refinance?
Refinancing your mortgage can help you save money, consolidate debt, or access your home's equity for renovations or investments.

## Refinancing Options
- **Rate Reduction**: Lower your interest rate
- **Payment Reduction**: Extend amortization to reduce payments
- **Debt Consolidation**: Pay off high-interest debt
- **Equity Access**: Use your home's equity for renovations
...
Contact me to explore your refinancing options today.`,
    blocks: [
      {
        "__component": "blocks.hero",
        "heading": "Refinancing Solutions",
...
Ready to explore your options? Contact me today!`
  ...
  },
  {
    ...
    content: `# Investment Properties

## Building Your Portfolio
Real estate investment can be a powerful wealth-building strategy. I'll help you secure the best financing for your investment properties.

## Investment Property Financing
- **Rental Property Mortgages**: Competitive rates for rental properties
- **Multi-Unit Properties**: Financing for duplexes and triplexes
- **Commercial Properties**: Small commercial space financing
...
Contact me to discuss your investment property financing needs.`,
    blocks: [
      {
        "__component": "blocks.hero",
        "heading": "Investment Properties",
...
Whether you're buying your first commercial space or expanding your business, I'll help you secure the right financing.
...
## Financing Options
- **Traditional Commercial Mortgages**: Long-term financing
- **SBA Loans**: Government-backed small business loans
- **Bridge Loans**: Short-term financing solutions
- **Construction Loans**: New construction financing

Contact me to discuss your commercial property financing needs.`,
    blocks: [
      {
        "__component": "blocks.hero",
        "heading": "Commercial Mortgages",
...
Ready to start your home buying journey? Contact me for a free consultation and pre-approval. I'll help you understand all available programs and find the best mortgage solution for your situation.`,
    featuredImage: 7,
    author: 2,
    tags: ["first-time-buyers", "toronto", "programs", "incentives"]
  },
  {
...
Ready to explore your mortgage options? Contact me for a free consultation and rate comparison.`,
    featuredImage: 7,
    author: 2,
    tags: ["mortgage-rates", "toronto", "2025", "trends"]
  },
  {
...
Ready to get pre-approved? Contact me for a free consultation and pre-approval. I'll guide you through the entire process and help you secure the best mortgage for your situation.`,
    featuredImage: 7,
    author: 2,
    tags: ["pre-approval", "home-buying", "mortgage-process", "toronto"]
  },
  {
...
Ready to explore investment property financing? Contact me for a consultation. I'll help you understand your financing options and develop a strategy for building your real estate portfolio.`,
    featuredImage: 7,
    author: 2,
    tags: ["investment-properties", "real-estate", "financing", "toronto"]
  },
  {
...
Ready to explore refinancing options? Contact me for a free consultation. I'll analyze your current mortgage and help you determine if refinancing makes sense for your financial goals.`,
    featuredImage: 7,
    author: 2,
    tags: ["refinancing", "mortgage", "home-equity", "debt-consolidation"]
  }
];
  ...
  try {
    ...
    const updatedBlocks = getData.data.blocks.map(block => {
      if (block.__component === 'blocks.hero') {
        return enhancedContent.hero;
      } else if (block.__component === 'blocks.card-grid') {
        return enhancedContent.services;
      }
      return block;
    });
      ...
      body: JSON.stringify({
        data: {
          ...
          defaultSeo: {
            ...
            metaDescription: "Professional mortgage services in Toronto. First-time buyer, refinancing, investment properties. Get the best rates with personalized service.",
            keywords: "mortgage agent toronto, first time home buyer, refinancing, investment properties, mortgage rates"
          }
        }
      })
    });
...
async function main(apiToken) {
  try {
    ...
    console.log('   ✅ Updated global settings and SEO');
...
if (!apiToken) {
  ...
  console.log('Run this script with: node update-comprehensive-content.js YOUR_TOKEN_HERE');
  process.exit(1);
}
