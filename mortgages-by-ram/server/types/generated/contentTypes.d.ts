...
export interface ApiFormSubmissionFormSubmission
  ...
  info: {
    description: 'Contact form and pre-approval submissions';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downPayment: Schema.Attribute.String;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    employmentStatus: Schema.Attribute.Enumeration<
      ['employed', 'self-employed', 'contract', 'retired', 'other']
    >;
    formType: Schema.Attribute.Enumeration<
      ['pre-approval', 'contact', 'general']
    > &
    ...
    propertyValue: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
