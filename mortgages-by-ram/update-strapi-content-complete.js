...
// Complete Strapi API update script for landing page content
const API_BASE = 'http://localhost:1337/api';

// Updated blocks with preserved IDs and structure
const updatedBlocks = [
  {
...
if (!apiToken) {
  ...
  console.log('Run this script with: node update-strapi-content-complete.js YOUR_TOKEN_HERE');
  process.exit(1);
}
